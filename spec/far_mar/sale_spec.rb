  ...
  describe FarMar::Sale do
    ...
    describe ".all" do
      ...
      it "contains instances of the Sale class" do
        sale_total = FarMar::Sale.all.length
        expect(FarMar::Sale.all[0]).to be_an_instance_of(FarMar::Sale)
        expect(FarMar::Sale.all[sale_total - 1]).to be_an_instance_of(FarMar::Sale)
        expect(FarMar::Sale.all[sale_total]).to be nil
      end
    end
    ...
    describe ".between(beginning_time, end_time)" do
      before :each do
        ...
        @begin_string = "2013-11-06 08:35:40 -0800"
        @end_string = "2013-11-13 08:35:16 -0800"
      end
      ...
      it "returns the correct number of Sale instances" do
        ...
        expect(FarMar::Sale.between(@begin_string, @end_string).length).to eq(12798)
